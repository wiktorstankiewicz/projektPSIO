package gra.model.postacie;

import gra.model.atakiInterfejs.IAtakiInterface;
...
abstract public class Postac implements Serializable {
    ...
    protected Bron bron;
    protected IAtakiInterface specjalnyAtak;
    protected IAtakiInterface zwyklyAtak;
    ...
    public void setZwyklyAtak(IAtakiInterface zwyklyAtak) {
        this.zwyklyAtak = zwyklyAtak;
    }

    public void setSpecjalnyAtak(IAtakiInterface specjalnyAtak) {
    ...
    public IAtakiInterface getZwyklyAtak() {
        return zwyklyAtak;
    }

    public IAtakiInterface getSpecjalnyAtak() {
