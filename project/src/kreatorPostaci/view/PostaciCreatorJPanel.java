...
public class PostaciCreatorJPanel extends JPanel implements ModelObserver {
	...
	public PostaciCreatorJPanel(ICreatorModel model, ICreatorController controller, JFrame frame){
	...
	private void makeButtons(){
		...
		zapiszButton.addActionListener(new CreatorController.ZapiszZmianyListener(model));
